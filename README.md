...
# This is modified version of the above where I removed the swordphish related stuff and added A VT link for the first from recieved IP which is usually the originating IP from the email. use visual studio 2017 and use it is publish menu to create installer. modify the names as you wish. 
